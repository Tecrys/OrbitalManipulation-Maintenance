...
//                        WeaponGroupAPI Group = FIGHTER.getWeaponGroupFor(weapon);
                        ...
                        if (this.mothership.equals(player) &&  engine.isUIAutopilotOn()) {
                            ...
                            if (Mouse.isButtonDown(2) && !player.getFluxTracker().isOverloadedOrVenting() && (dronewep.getType() == MISSILE) && dronewep.getSlot().getId().equals("smlhybridslot")) {
                                drone.giveCommand(ShipCommand.FIRE, mousepos, 0);           //clicky left drone shooty
                            }
                        }
                    ...
                    if (this.mothership != null) {
                        ...
                        for (FighterWingAPI fighterWingAPI : list1) {
...

                            {
                                ...
                                if (this.mothership.getVariant().getWeaponSpec("smlhybridslot") != null) {
                                    mutableShipStatsAPI.getVariant().addWeapon("smlhybridslot", this.mothership.getVariant().getWeaponId("smlhybridslot"));
