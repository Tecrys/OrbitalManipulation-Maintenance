...
public class synergypodAI extends BaseEveryFrameCombatPlugin {

    private final pidController controller;
    private final ShipAPI mothership;
    private final ShipAPI drone;

    public synergypodAI(ShipAPI drone, ShipAPI mothership) {
    ...
    public void advance(float amount, List<InputEventAPI> events) {
        ...
        synergypodManager manager = utils.getFirstListenerOfClass(mothership, synergypodManager.class);
