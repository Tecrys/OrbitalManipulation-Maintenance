...
public class omm_MilitarySubmarketPlugin extends BaseSubmarketPlugin {
	
	public static Logger log = Global.getLogger(omm_MilitarySubmarketPlugin.class);
	...
	public void updateCargoPrePlayerInteraction() {
		...
		if (okToUpdateShipsAndWeapons()) {
			...
			addWeapons(weapons, weapons + 2, 3, "freitag_corporation");
			...
			addHullMods(4, 2 + itemGenRandom.nextInt(4), "freitag_corporation");
		}
...
//		limit *= com.getCommodity().getEconUnit();
		...
		float limit = omm_marketplugin.getBaseStockpileLimit(com);
