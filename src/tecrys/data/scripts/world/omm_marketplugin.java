...
public class omm_marketplugin extends BaseSubmarketPlugin {
	...
	public void updateCargoPrePlayerInteraction() {
		...
		if (okToUpdateShipsAndWeapons()) {
			...
			addWeapons(weapons, weapons + 2, 0, "freitag_corporation");
			addFighters(fighters, fighters + 2, 0, "freitag_corporation");
			...
			addHullMods(1, 1 + itemGenRandom.nextInt(3), "freitag_corporation");
		}
