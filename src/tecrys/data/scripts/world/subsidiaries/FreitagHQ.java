...
import tecrys.data.scripts.world.omm_AddMarketplace;
import java.util.ArrayList;
import java.util.Arrays;

public class FreitagHQ {

    public void generate(SectorAPI sector, boolean ommFaction) {
        String faction = "freitag_corporation";
        if(!LunaSettings.getBoolean("OMM", "omm_faction")){
        ...
        CustomCampaignEntityAPI customCampaignEntityAPI2 = valhalla.addCustomEntity("freitag_hq", "Freitag Corporation HQ", "freitag_hq", faction);
        ...
        MarketAPI HQmarket = omm_AddMarketplace.addMarketplace(faction, (SectorEntityToken) customCampaignEntityAPI2, null, "Freitag Corporation HQ", 4, new ArrayList<>(Arrays.asList( //List of conditions for this method to iterate through and add to the market
