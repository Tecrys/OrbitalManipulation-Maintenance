...
public class omm_BlackMarketPlugin extends BaseSubmarketPlugin {
	
	public static Logger log = Global.getLogger(omm_BlackMarketPlugin.class);
...
//			}
			...
			factionPicker.add("freitag_corporation", 15f - stability);
			factionPicker.add(Factions.INDEPENDENT, 4f);
			factionPicker.add("freitag_corporation", 6f);
			...
			if (military) {
				...
				addWeapons(weapons, weapons + 2, 3, "freitag_corporation", false);
				addFighters(fighters, fighters + 2, 3, "freitag_corporation");
			}
...
//			doctrine.setPhaseShips(2);
			...
			addShips("freitag_corporation",
					...
					Math.min(1f, Misc.getShipQuality(market, "freitag_corporation") + 0.5f),
					0f, // qualityMod
					null,
					doctrine);
